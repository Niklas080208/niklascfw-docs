...
4. In **Daybreak**:
   - Wähle **Install** aus
   - Wähle **Firmware auswählen** (Firmware xx.x.x)
   - Aktiviere **Preserve Settings**
   - Aktiviere **Install Fat32 + ExFat**
5. Nach dem **Neustart** sollte die neue **Firmware** installiert sein
